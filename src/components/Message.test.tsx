...
describe('Message', () => {
  ...
  it('renders "Correct!" when correct is true', () => {
    render(<Message correct={true} correctAnswer="ka" onNextQuestion={mockOnNextQuestion} />);
    expect(screen.getByText('Correct!')).toBeInTheDocument();
  });

  it('renders wrong message with correct answer when correct is false', () => {
    render(<Message correct={false} correctAnswer="ka" onNextQuestion={mockOnNextQuestion} />);
  ...
  it('renders nothing when correct is null', () => {
    const { container } = render(
      <Message correct={null} correctAnswer={null} onNextQuestion={mockOnNextQuestion} />
    );
